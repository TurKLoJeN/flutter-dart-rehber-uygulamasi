...
import 'package:phonebook/add_contact_page.dart';
...
class _ContactPageState extends State<ContactPage> {
                  ...
                  child: Dismissible(
                    ...
                    onDismissed: (direction) async {
                      ...
                      Scaffold.of(context).showSnackBar(SnackBar(
                        content: Text("${contact.isim} has been deleted"),
                    ...
                    child: ListTile(
                      leading: CircleAvatar(
                        ...
                        child: Text(
                          contact.isim[0].toUpperCase(),
                          style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold),
                        ),
                      ),
                      title: Text(contact.isim),
                      subtitle: Text(contact.telnumara),
                      trailing: IconButton(icon: Icon(Icons.phone), onPressed: () async => _callContact(contact.telnumara)),
                    ),
                  ),
                );
              });
  ...
  _callContact(String telnumara) async {
    String tel = "tel:$telnumara";
