...
class DbHelper {
  ...
  FutureOr<void> _onCreate(Database db, int version) async {
    return await db.execute("CREATE TABLE Contact(id INTEGER PRIMARY KEY, isim TEXT, telnumara TEXT, avatar TEXT)");
  }

  Future<List<Contact>> getContacts() async {
    var dbClient = await db;
    var result = await dbClient.query("Contact", orderBy: "isim");
